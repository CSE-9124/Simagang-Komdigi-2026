            ...
            <div class="content-card">
                ...
                <div class="p-6 border-b border-slate-100 flex flex-col lg:flex-row items-start gap-5">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="mt-4 flex flex-wrap gap-2">
                            @if ($status !== 'disetujui')
                                <form action="{{ route('admin.lowongan.approve', $lowongan->id) }}" method="POST">
                                    @csrf @method('PATCH')
                            ...
                            @endif
                            @if ($status !== 'ditolak')
                                <form action="{{ route('admin.lowongan.reject', $lowongan->id) }}" method="POST">
                                    @csrf @method('PATCH')
                                    <button type="submit" onclick="return confirm('Tolak lowongan ini?')"
                ...
                <div class="p-6 space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-3">
                            ...
                            <div class="detail-box">
                                ...
                                <p class="detail-value break-all">
                                    {{ optional($lowongan->industri)->email_industri ?? '-' }}</p>
                            </div>
                            <div class="detail-box">
                                <p class="detail-label">Nomor Telepon</p>
                                <p class="detail-value">{{ optional($lowongan->industri)->nomor_telepon_industri ?? '-' }}
                                </p>
                            </div>
                            <div class="detail-box">
                    ...
                    <div>
                        ...
                        <div class="description-box">
                            <p class="text-slate-600 text-sm leading-relaxed whitespace-pre-line">
                                {{ optional($lowongan->industri)->alamat_industri ?? '-' }}</p>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex items-center gap-3 mb-4">
                            <div class="section-icon bg-violet-50 text-violet-600"><i class="fas fa-circle-info"></i>
                            </div>
                            <div>
                        ...
                        <div class="description-box">
                            <p class="text-slate-600 text-sm leading-relaxed whitespace-pre-line">
                                {{ optional($lowongan->industri)->deskripsi_industri ?? '-' }}</p>
                        </div>
                    </div>
