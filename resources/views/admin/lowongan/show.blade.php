                ...
                <div class="mt-4 flex flex-wrap gap-2">
                    @if($status !== 'disetujui')
                        <form action="{{ route('admin.lowongan.approve', $lowongan->id) }}" method="POST">
                            @csrf @method('PATCH')
                            <button type="submit" onclick="return confirm('Setujui lowongan ini?')" class="btn-action btn-success">
                    ...
                    @if($status !== 'ditolak')
                        <form action="{{ route('admin.lowongan.reject', $lowongan->id) }}" method="POST">
                            @csrf @method('PATCH')
                            <button type="submit" onclick="return confirm('Tolak lowongan ini?')" class="btn-action btn-danger">
