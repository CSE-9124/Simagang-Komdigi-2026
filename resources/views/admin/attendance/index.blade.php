...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-100 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <h1
                    class="text-4xl font-bold leading-tight bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-3 pb-2">
                    Monitoring Absensi
                </h1>
            ...
            <div class="bg-white shadow-md rounded-lg p-6 mb-6 border-t-4 border-blue-500">
                ...
                <form method="GET" action="{{ route('admin.attendance.index') }}"
                    ...
                    <div class="flex items-end gap-2">
                        <button
                            class="flex-1 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold py-2 px-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center"
                            type="submit">
                            ...
                            <tbody class="bg-white divide-y divide-gray-100">
                                ...
                                @forelse($attendances as $attendance)
                                    <tr class="hover:bg-blue-50 transition-colors duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-center font-medium text-gray-900">
                                                {{ $attendance->intern->name }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap ">
                                            <span
                                                class="px-3 py-1 inline-flex text-center text-xs leading-5 font-semibold rounded-full
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center flex justify-center">
                                            @if ($attendance->photo_path)
                                                @php
                                                    $photoUrl = route('admin.attendance.photo', [
                                                        'filename' => basename($attendance->photo_path),
                                                    ]);
                                                @endphp
                                                <img src="{{ $photoUrl }}" alt="Check In" data-secure="true"
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center flex justify-center">
                                            @if ($attendance->photo_checkout)
                                                ...
                                                @endphp
                                                <img src="{{ $photoUrl }}" alt="Check Out" data-secure="true"
                                                    class="w-12 h-12 object-cover rounded-lg border-2 border-blue-200 cursor-pointer hover:border-blue-400 transition-all"
                                                    onclick="window.open('{{ $photoUrl }}', '_blank')"
                                                    title="Klik untuk melihat full size">
                                            @else
