        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 space-y-8">
                ...
                @if ($attendance->status == 'hadir')
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        @if ($attendance->photo_checkout)
                            @php
                                $photoCheckoutUrl = route('admin.attendance.photo', [
                ...
                @else
                    ...
                    <!-- Verifikasi -->
                    <form method="POST" action="{{ route('admin.attendance.update-document-status', $attendance) }}"
                        ...
                        <div>
                            ...
                            <select name="document_status" required
                                ...
                                <option value="pending" {{ $attendance->document_status == 'pending' ? 'selected' : '' }}>
                                    Pending</option>
                                <option value="approved"
                                    {{ $attendance->document_status == 'approved' ? 'selected' : '' }}>Approved</option>
                                <option value="rejected"
                                    {{ $attendance->document_status == 'rejected' ? 'selected' : '' }}>Rejected</option>
                            </select>
                        </div>
