                ...
                <div
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            ...
                            <div
                                class="w-16 h-16 bg-gradient-to-br from-yellow-500 to-orange-500 rounded-2xl flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300">
                ...
                <div
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            ...
                            <div
                                class="w-16 h-16 bg-gradient-to-br from-gray-500 to-gray-600 rounded-2xl flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300">
                ...
                <div
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            ...
                            <div
                                class="w-16 h-16 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300">
                        ...
                        <div class="space-y-3">
                            @foreach ($topMicroSkills->take(3) as $index => $row)
                                <div
                                    ...
                                    <span
                                        class="px-3 py-1 bg-indigo-100 text-center text-indigo-800 rounded-full text-xs font-semibold">
                                        {{ $row['total'] }} course
                                    </span>
                                </div>
                            @endforeach
