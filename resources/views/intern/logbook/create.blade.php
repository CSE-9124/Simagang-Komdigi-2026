...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="bg-white shadow rounded-lg p-6">
        <h1 class="text-2xl font-bold text-gray-900 mb-6">Tambah Logbook</h1>
        ...
        <form method="POST" action="{{ route('intern.logbook.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                <label for="photo" class="block text-sm font-medium text-gray-700 mb-2">Foto Dokumentasi (Opsional)</label>
