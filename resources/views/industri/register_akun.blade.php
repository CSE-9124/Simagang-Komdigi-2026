            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mt-6 mb-6">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Tambahkan industri baru untuk keperluan magang dan kerjasama dengan Komdigi.
                    </p>
                </div>
            </div>

            <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                <form method="POST" action="{{ route('industri.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="p-8 border-b">
                        <div class="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                <h2 class="text-lg sm:text-xl font-bold text-blue-900">Informasi Akun Industri</h2>
                                <p class="text-sm text-gray-600"> Silakan lengkapi informasi akun dan profil perusahaan Anda untuk melanjutkan proses pendaftaran industri.</p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="flex items-center mt-1 w-full bg-blue-50 rounded-xl px-4 py-3.5 border border-gray-300">
                                    <input value="Admin Industri" type="text" disabled
